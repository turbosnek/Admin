<?php
    ...
    if ($_POST) // V poli _POST něco je, odeslal se formulář
    {
        ...
        header('Location: index.php?stranka=detail_zamestnance&zamestnanci_id=' . htmlspecialchars($zamestnanec['zamestnanci_id']) . ''); // Po odeslání dat do databáze přesměrujeme na detail uživatele
        exit();
    }
?>
