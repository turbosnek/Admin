<?php
    ...
    /**
     * Vybereme všechny záznamy z tabulky "zamestnanci" podle jejich pracovní pozice "Expedice"
     */
     $zamestnanci = Db::queryAll('
             SELECT *
             FROM zamestnanci
             WHERE pracovni_pozice="Expedice"
             ORDER BY zamestnanci_id
             ');
?>


<H1>Výpis zaměstnanců firmy na pozici "retrakář"</H1>
...
<?php
     ...
     /**
      * Pomocí cyklu foreach vypíšeme zaměstnance firmy na pozici expedice
      */
